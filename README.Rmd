...
- air formatting (`usethis::use_air()`), plus `panache.toml` and `jarl.toml`
  configs
...
- a `.pre-commit-config.yaml` with panache, air and jarl hooks pinned to their
  latest release, plus README-freshness and roxygen2 checks, installed with
